...
2. Depend on the libraries.
   ...
   libraryDependencies ++= Seq(
     "io.github.shogowada" %%% "scalajs-reactjs" % "0.7.0", // For react facade
     "io.github.shogowada" %%% "scalajs-reactjs-router" % "0.7.0", // Optional. For react-router facade
     "io.github.shogowada" %%% "scalajs-reactjs-redux" % "0.7.0" // Optional. For react-redux facade
   )
   ```
