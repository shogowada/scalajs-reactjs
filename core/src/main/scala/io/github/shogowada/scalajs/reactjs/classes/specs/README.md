...
You can inherit one of the following specs to define behavior for your React class.

- [ReactClassSpec](ReactClassSpec.scala)
- [StatelessReactClassSpec](StatelessReactClassSpec.scala)
    - This is to define stateless React class.
